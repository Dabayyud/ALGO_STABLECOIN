...
contract InvariantTest is StdInvariant, Test {
    ...
    function setUp() external {
        ...
        // Call it in technical order, order that aligns with the logic and implementation of the contract
        handlerTest = new HandlerTest(dscEngine, dsc);
        targetContract(address(handlerTest)); // Tells foundry to go wild on this contract, new target contract
    }
    ...
    function invariant_engineMustAlwaysBeOverCollateralized() public view {
        ...
        uint256 totalCollateralValueInUsd =
            dscEngine._getUSDValue(wETH, totalwethDeposited) + dscEngine._getUSDValue(wBTC, totalwbtcDeposited);
